    ...
    <div>
      ...
      <Form method="POST">
        ...
        <div>
          ...
          <div>
            <input
              ...
              duration-300 placeholder:text-stone-400 focus:outline-none focus:ring focus:ring-yellow-400
              md:px-6 md:py-3"
              type="text"
              name="address"
              required
        ...
        <div>
          ...
          <button
            className="inline-block rounded-full bg-yellow-400 px-4 py-4 font-semibold uppercase 
...
export async function action({ request }) {
  ...
  // if there are no errors, create the order and redirect to the order page
