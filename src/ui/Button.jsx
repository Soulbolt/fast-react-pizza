...
function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    secondary: `inline-block rounded-full border-2 border-stone-300 font-semibold uppercase 
                    tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300
                    hover:text-stone-800 focus-bg-stone-300 focus:text-stone-800 focus:outline-none 
